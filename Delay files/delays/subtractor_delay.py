...
fp3 = open("subtractor_delay_analysis.txt",'w')
fp3.close()

#this is the command this helps to choose which file to run
command = "ngspice subtractor_destination.cir"
...
V_in_B3 bb3 gnd PULSE(0 1.8 0ns 100ps 100ps 40ns 80ns)
    ...
    for l in range(4):
        fp1 = open("alu.cir",'r')
        fp2 = open("subtractor_destination.cir",'w')
        fp3 = open("subtractor_delay_analysis.txt",'a')
        mode1 = "RISE"
        mode2 = "RISE"
        mode3 = "FALL"
        mode4 = "FALL"
